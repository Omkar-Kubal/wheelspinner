...
export default function PrivacyPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert text-slate-400 space-y-6 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-6 mb-2">3. Google Analytics</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white mt-6 mb-2">5. Contact</h2>
